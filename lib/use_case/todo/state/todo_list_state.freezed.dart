...
abstract class $TodoListStateCopyWith<$Res> {
  ...
  $Res call({List<Todo> todoList, Todo todo});
...
class _$_TodoListState implements _TodoListState {
  const _$_TodoListState(
      {final List<Todo> todoList = const <Todo>[], this.todo = const Todo()})
      : _todoList = todoList;
  ...
  @override
  String toString() {
    return 'TodoListState(todoList: $todoList, todo: $todo)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_TodoListStateToJson(this);
  }
}

abstract class _TodoListState implements TodoListState {
  const factory _TodoListState({final List<Todo> todoList, final Todo todo}) =
      _$_TodoListState;
